...
export async function fetchGameData(gameName, level, option= "Everything") {
    ...
    if (option === "Everything") {
        ...
        systemprompt = `Provide an extremely detailed story recap of the provided video game, up until the provided level in that game. Only include a detailed summary of the game's story up to this point in a JSON format with the key "recap".`;
    } else if (option === "Objective") {
        systemprompt = `Provide an extremely detailed description of the current objective for the provided video game at the provided level for that video game. Only include detailed objective information in a JSON format with the key "objective".`;
    } else if (option === "Controls and Mechanics") {
        systemprompt = "Provide an extremely detailed recap list of the controls and mechanics for the provided video game. Only include detailed controls and mechanics information in a JSON format with the key \"controls\". \n\nThe format  should follow:\n\n```json\n{\n  \"controls\": [\n    \"Control 1: Description of control or mechanic\",\n    \"Control 2: Description of control or mechanic\",\n    \"...additional controls as needed\"\n  ]\n}\n```\n\nAn Example:\n\n```json\n{\n  \"controls\": [\n    \"Basic movement: Use the joystick to navigate\",\n    \"Jumping: Press 'A' to jump\",\n    \"Interacting: Press 'X' to interact with objects\"\n  ]\n}\n```";
    }
    //Put in try block in case call fails
    try {
        //Make a Chat Completion Request
        const response = await openai.chat.completions.create({
            model: 'gpt-4o', //or another model, 4o mini has been unsatisfactory so trying 4o proper...
            messages: [
